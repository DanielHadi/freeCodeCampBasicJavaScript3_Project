...
const getResultDiv = document.getElementById("results-div");
...
const clearOutput = () => {
    getResultDiv.innerText = "";
}

getCheckbtn.addEventListener("click", checkInput);
getClearbtn.addEventListener("click", clearOutput);
